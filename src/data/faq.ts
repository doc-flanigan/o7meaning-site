...
export const faqs: FAQ[] = [
  {
    ...
    answer:
      'o7 is a text emoticon representing a salute. The "o" is a head and the "7" is a raised arm completing the gesture. Gamers type it to greet, respect, or bid farewell to other players.',
  },
  {
